...
export const team: Member[] = [
  {
    ...
    bio: "Samuel, 25, is a computer science student at UTEP, graduating in December 2026, and the founder of Nerrix Digital, a studio that builds and hosts websites for El Paso businesses. He spent the summer of 2025 as a software engineering intern at Moving Mountains Consulting, where he replaced a paid testing service with an in-house Playwright platform, and he has run a five-person crew at Kasa Roofing since 2023. His contractor platform, KasaPro, is in daily use at two businesses and lent this portal its rail and its neutrals. He works in TypeScript, React and Node, and speaks English and Spanish.",
    photo: null
  },
  {
    id: "jazmin",
